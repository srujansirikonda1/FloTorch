...
class BGEEndpointSageMakerEmbedder(SageMakerEmbedder):
    ...
    def embed(self, text: Union[str, List[str]], dimensions: int = 1024, normalize: bool = True) -> Union[
    ...
    def extract_embedding(self, response: Union[List[float], List[List[float]], Dict]) -> Union[
        List[float], List[List[float]]]:
